...
<div class="top">
	<ul>
		...
		<li><a class="launch-modal" href="#" data-modal-id="modal-register">问题反馈</a></li>
		<li><a href="">联系我们</a></li>
...
<div class="main">
	<div class="denglu">
		<div class="text" style="font-size:18px;"><strong>重要提示：</strong><br /><br />
...
<%--<a class="btn btn-link-1 launch-modal" data-modal-id="modal-register">Launch modal</a>--%>
